...
class PagRegistercompletedWidget extends StatefulWidget {
  const PagRegistercompletedWidget({Key key}) : super(key: key);

  @override
  _PagRegistercompletedWidgetState createState() =>
      _PagRegistercompletedWidgetState();
}

class _PagRegistercompletedWidgetState
    extends State<PagRegistercompletedWidget> {
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0, 10, 0, 0),
                                    child: Text(
                                      'Tu cuenta ha sido registratada!!',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyText1
                                          .override(
                                            fontFamily: 'Poppins',
